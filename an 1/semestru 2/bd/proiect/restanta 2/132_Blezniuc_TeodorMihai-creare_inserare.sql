...
CREATE TABLE calator (
    id_calator NUMBER(9) PRIMARY KEY,
...
INSERT INTO calator VALUES (seq_calator.NEXTVAL, 'Georgescu', 'Vlad', '3000525123456', 'vlad@email.com');
...
-- Inserări
INSERT INTO promotie VALUES (seq_promotie.NEXTVAL, 'Student', 50, 'Legitimație student');
INSERT INTO promotie VALUES (seq_promotie.NEXTVAL, 'Pensionar', 100, 'Act de pensionare');
INSERT INTO promotie VALUES (seq_promotie.NEXTVAL, 'Elev', 100, 'Carnet de elev');
INSERT INTO promotie VALUES (seq_promotie.NEXTVAL, 'Militar', 25, 'Ordin de deplasare');
INSERT INTO promotie VALUES (seq_promotie.NEXTVAL, 'Student cu mențiuni speciale', 100, 'Adeverință mențiuni');
...
INSERT INTO tip_bilet VALUES (seq_tip_bilet.NEXTVAL, 'cu animal companie', 'Călătorie cu animal de companie');
INSERT INTO tip_bilet VALUES (seq_tip_bilet.NEXTVAL, 'cu bicicleta', 'Călătorie cu bicicletă');
...
CREATE TABLE clasa (
    ...
    denumire VARCHAR2(30) NOT NULL UNIQUE,
    suprataxa NUMBER(6,2) DEFAULT 0 CHECK (suprataxa >= 0)
);

-- Inserări
INSERT INTO clasa VALUES (seq_clasa.NEXTVAL, 'Clasa I', 15.00);
INSERT INTO clasa VALUES (seq_clasa.NEXTVAL, 'Clasa a II-a', 0.00);
INSERT INTO clasa VALUES (seq_clasa.NEXTVAL, 'Cușetă 6 paturi', 50.00);
INSERT INTO clasa VALUES (seq_clasa.NEXTVAL, 'Cușetă 4 paturi', 75.00);
INSERT INTO clasa VALUES (seq_clasa.NEXTVAL, 'Cușetă 2 paturi', 150.00);
...
-- Inserări
INSERT INTO operator_feroviar VALUES (seq_operator_feroviar.NEXTVAL, 'CFR Călători', 'public');
INSERT INTO operator_feroviar VALUES (seq_operator_feroviar.NEXTVAL, 'RegioTrans', 'privat');
INSERT INTO operator_feroviar VALUES (seq_operator_feroviar.NEXTVAL, 'Transferoviar', 'privat');
INSERT INTO operator_feroviar VALUES (seq_operator_feroviar.NEXTVAL, 'Softrans', 'privat');
INSERT INTO operator_feroviar VALUES (seq_operator_feroviar.NEXTVAL, 'Astra', 'privat');
...
-- Inserări
INSERT INTO statie VALUES ('București Nord', 'București');
INSERT INTO statie VALUES ('Brașov', 'Brașov');
INSERT INTO statie VALUES ('Sinaia', 'Sinaia');
INSERT INTO statie VALUES ('Sibiu', 'Sibiu');
INSERT INTO statie VALUES ('Timișoara Nord', 'Timișoara');
...
-- Inserări
INSERT INTO ruta VALUES (seq_ruta.NEXTVAL, 'București Nord', 'Brașov');
INSERT INTO ruta VALUES (seq_ruta.NEXTVAL, 'Brașov', 'Sibiu');
INSERT INTO ruta VALUES (seq_ruta.NEXTVAL, 'Sibiu', 'Timișoara Nord');
INSERT INTO ruta VALUES (seq_ruta.NEXTVAL, 'Timișoara Nord', 'Sinaia');
INSERT INTO ruta VALUES (seq_ruta.NEXTVAL, 'Sinaia', 'București Nord');
...
-- Inserări
INSERT INTO tren VALUES (seq_tren.NEXTVAL, '1752', 'IR', 1, 1);
INSERT INTO tren VALUES (seq_tren.NEXTVAL, '456', 'R', 2, 2);
INSERT INTO tren VALUES (seq_tren.NEXTVAL, '78', 'IR', 3, 3);
INSERT INTO tren VALUES (seq_tren.NEXTVAL, '321', 'RE', 4, 4);
INSERT INTO tren VALUES (seq_tren.NEXTVAL, '1111', 'R', 1, 5);
...
INSERT INTO program_tren VALUES (5, 'București Nord', 2, TO_DATE('18:30','HH24:MI'), NULL);
...
INSERT INTO tarif VALUES (2, 2, 2, 70.00);
INSERT INTO tarif VALUES (3, 1, 1, 120.00);
INSERT INTO tarif VALUES (3, 1, 2, 200.00);
...
CREATE TABLE bilet (
    ...
    FOREIGN KEY (id_ruta, id_clasa, id_tip_bilet) REFERENCES tarif(id_ruta, id_clasa, id_tip_bilet),
...
-- Inserări
INSERT INTO bilet VALUES (seq_bilet.NEXTVAL, 1, 1, 1, 1, 1, SYSDATE, TO_DATE('2025-10-01', 'YYYY-MM-DD'), 1);
INSERT INTO bilet VALUES (seq_bilet.NEXTVAL, 2, 1, 2, 1, 2, SYSDATE, TO_DATE('2025-09-12', 'YYYY-MM-DD'), 1);
INSERT INTO bilet VALUES (seq_bilet.NEXTVAL, 3, 2, 2, 2, NULL, SYSDATE, TO_DATE('2025-10-01', 'YYYY-MM-DD'), 2);
INSERT INTO bilet VALUES (seq_bilet.NEXTVAL, 4, 3, 1, 2, 1, SYSDATE, TO_DATE('2025-10-02', 'YYYY-MM-DD'), 3);
INSERT INTO bilet VALUES (seq_bilet.NEXTVAL, 5, 4, 1, 1, NULL, SYSDATE, TO_DATE('2025-09-23', 'YYYY-MM-DD'), 4);
...
INSERT INTO legitimatie VALUES (seq_legitimatie.NEXTVAL, 5, 5, 'Unibuc', TO_DATE('2025-08-31', 'YYYY-MM-DD'));
