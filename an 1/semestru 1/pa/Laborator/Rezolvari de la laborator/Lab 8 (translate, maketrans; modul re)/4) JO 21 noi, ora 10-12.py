## Laborator 8, JO 21 noi, ora 10-12
...
a) puternica: daca contine cel putin o litera mica, cel putin o litera mare, cel putin o cifra, cel putin un simbol special (fara spatii), are lungimea minim 10 caractere
...
def parola(sir):
    # ## c) slaba: daca are doar litere mici sau doar mari sau
    # ## doar cifre, iar lungimea este maxim 5
    ...
    r = re.search(r"^[a-z]{1,5}$|^[A-Z]{1,5}$|^[0-9]{1,5}$", sir)
    print(r)
