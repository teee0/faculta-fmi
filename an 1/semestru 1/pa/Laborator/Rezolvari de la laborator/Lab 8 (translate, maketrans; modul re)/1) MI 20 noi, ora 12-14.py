## Laborator 8, MI 20 noi, ora 12-14
...
# print(ls)
# #
# #split sa pastram doar literele - orice numar este separator+ separatorii uzuali
# ls=re.split(r"[\d., ;]+",p)
# print(ls)
#
#
...
b) medie: daca contine cel putin o litera mica, una mare, o cifra, are lungimea intre 6 si 9 caractere
c) slaba: daca are doar litere mici sau doar mari sau doar cifre, iar lungimea este maxim 5
"""

# def parola(sir):
#     # R = re.search(r"[a-z]+", sir)
#     if re.search(r"[a-z]+", sir) and re.search(r"[A-Z]+", sir) and re.search(r"[0-9]+", sir)\
#             and re.search(r"[\W\S]+", sir) and re.search(r"[^\s]+", sir):
#         print(sir)
#
# parola("abdrA9#")
