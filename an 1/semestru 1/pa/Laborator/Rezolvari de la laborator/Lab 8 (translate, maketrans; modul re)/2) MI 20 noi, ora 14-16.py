## Laborator 8, MI 20 noi, ora 14-16
...
a) puternica: daca contine cel putin o litera mica, cel putin o litera mare, cel putin o cifra, 
cel putin un simbol special (fara spatii), are lungimea minim 10 caractere
b) medie: daca contine cel putin o litera mica, una mare, o cifra, are lungimea 
intre 6 si 9 caractere
c) slaba: daca are doar litere mici sau doar mari sau doar cifre, iar lungimea este maxim 5
"""

def parola(sir):

    ## c) slaba: daca are doar litere mici
    ## sau doar mari sau doar cifre, iar lungimea este maxim 5
    ...
    # # b) medie: daca contine cel putin o litera mica, una mare, o cifra, are lungimea
    # # intre 6 si 9 caractere
    # a = re.search(r"[a-z]{1,}", sir)
    # A = re.search(r"[A-Z]+", sir)
    # z = re.search(r"[0-9]+", sir)
    # t = re.search(r"^[a-zA-Z0-9]{6,9}$", sir)
    #
    # print(a, A, z, t, sep="\n")
    #
    # if a and A and z and t:
    ...
    A = re.search(r"[A-Z]+", sir)
    z = re.search(r"[0-9]+", sir)
    w = re.search(r"[^a-zA-Z0-9\s]+", sir)
    t = re.search(r"^[a-zA-Z0-9\S]{10,}$", sir)

    print(a, A, z, w, t, sep="\n")

    if a and A and z and w and t:
        print(f"parola {sir} este puternica!")
