## Laborator 8, MI 20 noi, ora 16-18
...
a) puternica: daca contine cel putin o litera mica, cel putin o litera mare, 
cel putin o cifra, cel putin un simbol special (fara spatii), are lungimea 
minim 10 caractere
b) medie: daca contine cel putin o litera mica, una mare, o cifra, 
are lungimea intre 6 si 9 caractere
...
def parola(sir):
    ...
    A = re.search(r"[A-Z]", sir)
    c = re.search(r"[0-9]", sir)
    e = re.search(r"[0-9]", sir)
    t = re.search(r"[^a-zA-Z0-9\s]", sir)
    w = re.search(r"^\S{10,}$", sir)
    print(a, A, c, e, t, w, sep="\n")
    if a and A and c and e and t and w:
